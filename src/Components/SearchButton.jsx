...
function SearchButton() {
  return (
    <Link to='/flights'><svg className="searchButton" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000">
        ...
        stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></g></svg></Link>
  )
}
